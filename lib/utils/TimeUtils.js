...
var MathUtils_1 = require("./deprecated/MathUtils");
var TimeUtils = /** @class */ (function () {
    ...
    TimeUtils.getDurationInMinutes = function (from, to) {
        var fromDate = moment_1.default("1970-01-01T" + from);
        var toDate = moment_1.default("1970-01-01T" + to);
        var duration = moment_1.default.duration(toDate.diff(fromDate));
    ...
    TimeUtils.getStartOfTheDay = function (date) {
        ...
        return moment_1.default(date).startOf("day").toDate();
    };
