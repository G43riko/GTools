...
export function vectorSquareIntersect3d(r1x, r1y, r1z, r2x, r2y, r2z, s1x, s1y, s1z, s2x, s2y, s2z, s3x, s3y, s3z) {
    return vectorSquareIntersect3d_2(new Vector3(r1x, r1y, r1z), new Vector3(r2x, r2y, r2z), new Vector3(s1x, s1y, s1z), new Vector3(s2x, s2y, s2z), new Vector3(s3x, s3y, s3z));
}
export function vectorSquareIntersect3d_2(R1, R2, S1, S2, S3) {
