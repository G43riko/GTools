export function fixXYWH(minMax, xywh) {
...
export function fixPosSize(minMax, target) {
    const result = Object.assign({}, target.position);
...
export function fixSphere(minMax, sphere) {
    const result = Object.assign({}, sphere.center);
