...
exports.RayCast = exports.RaycastResult = exports.RayMode = exports.Ray = void 0;
...
var Ray = (function () {
    ...
    Ray.fromLine = function (start, end) {
        var direction = math_1.Vector2.sub(end, start);
        var length = direction.length;
        return new Ray(start, math_1.Vector2.normalize(direction), length);
    };
    return Ray;
}());
exports.Ray = Ray;
