...
export class Plane3D {
     ...
     */
    public static fromNormalAndDistance(_normal: ReadonlySimpleVector3, _distance: number): Plane3D {
    ...
    public isFacingTo(point: ReadonlySimpleVector3): boolean {
        return Vector3.dot(this.normal, Vector3.sub(point, this.point, Vector3.TMP)) > 0;
    }
}
