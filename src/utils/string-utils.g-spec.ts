...
import "mocha";
import * as TESTED_OBJ from "./string-utils";
...
describe("string-utils", () => {
    ...
    it("It should test function template", () => {
        expect(TESTED_OBJ.template("{{name}} is {{age}} years old", {name: "Gabriel", age: 23})).to.be.equal("Gabriel is 23 years old");
    });

    it("It should test function between", () => {
        expect(TESTED_OBJ.between("my name is gabriel and I am 26 years old", "NAME", "gabriel")).to.be.equal("my name is ");
        expect(TESTED_OBJ.between("my name is gabriel and I am 26 years old", "name", "GABRIEL")).to.be.equal(" is gabriel and I am 26 years old");
        expect(TESTED_OBJ.between("my name is gabriel and I am 26 years old", "name", "gabriel")).to.be.equal(" is ");
        expect(TESTED_OBJ.between("my name is gabriel and I am 26 years old", "name", "gabriel", true)).to.be.equal("is");
    });
