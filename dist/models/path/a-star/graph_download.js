...
var a_star_download_1 = require("./a-star_download");
var grid_node_download_1 = require("./grid-node_download");
var Graph = (function () {
    function Graph(gridIn, options) {
        ...
        for (var x = 0; x < gridIn.length; x++) {
            ...
            for (var y = 0; y < row.length; y++) {
                var node = new grid_node_download_1.GridNode(x, y, row[y]);
                this.grid[x][y] = node;
    ...
    Graph.prototype.init = function () {
        ...
        for (var _i = 0, _a = this.nodes; _i < _a.length; _i++) {
            var item = _a[_i];
            a_star_download_1.astar.cleanNode(item);
        }
    };
