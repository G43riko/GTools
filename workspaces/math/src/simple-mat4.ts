...
export class SimpleMat4 {
    ...
    /**
     * @see https://glmatrix.net/docs/mat4.js.html#line1224
     */
    public getRotation(out: Quaternion = new Quaternion()): Quaternion {
        ...
        const sm11 = this.data[0] * is1;
        const sm12 = this.data[1] * is2;
        const sm13 = this.data[2] * is3;
        const sm21 = this.data[4] * is1;
        const sm22 = this.data[5] * is2;
        const sm23 = this.data[6] * is3;
        const sm31 = this.data[8] * is1;
        const sm32 = this.data[9] * is2;
        const sm33 = this.data[10] * is3;
    ...
    public getTranslation<T extends SimpleVector3>(out: T): T;
    public getTranslation<T extends SimpleVector3>(out: T = SimpleVector.empty3() as unknown as T): T {
        out.x = this.data[12];
        out.y = this.data[13];
        out.z = this.data[14];
    ...
    public getScaling(): SimpleVector3;
    public getScaling<T extends SimpleVector3>(out: T): T;
    /**
     * @see https://glmatrix.net/docs/mat4.js.html#line1197
     */
    public getScaling<T extends SimpleVector3>(out: T = SimpleVector.empty3() as unknown as T): T {
    ...
    public static fromTranslation(translation: SimpleVector3): SimpleMat4;
     ...
     * ```
     */
    public static fromTranslation<T extends SimpleMat4>(
    ...
    public static fromScale(scale: SimpleVector3): SimpleMat4;
     ...
     * ```
     */
    public static fromScale<T extends SimpleMat4>(
        scale: SimpleVector3,
        result: T = SimpleMat4.create() as unknown as T,
    ): T {
    ...
    public static fromRotationTranslationScale<T extends SimpleMat4>(
        rotation: Quaternion,
        translation: ReadonlySimpleVector3,
        scale: ReadonlySimpleVector3,
        result: T,
    ...
    public static from(param: {
        scale?: ReadonlySimpleVector3 | ReadonlyTrinity<number>;
        translation?: ReadonlySimpleVector3 | ReadonlyTrinity<number>;
        rotation?: Quaternion;
        angle?: number;
        axes?: number | ReadonlySimpleVector3;
        rotX?: number;
        rotY?: number;
        rotZ?: number;
    }): SimpleMat4;
    public static from<T extends SimpleMat4>(param: {
        scale?: ReadonlySimpleVector3 | ReadonlyTrinity<number>;
        translation?: ReadonlySimpleVector3 | ReadonlyTrinity<number>;
        rotation?: Quaternion;
        angle?: number;
    ...
    public static fromQuaternion(v: Quaternion): SimpleMat4;
    public static fromQuaternion<T extends SimpleMat4>(v: Quaternion, result: T): T;
    public static fromQuaternion<T extends SimpleMat4>(
        v: Quaternion,
        result: T = SimpleMat4.create() as unknown as T,
    ): T {
        const x2 = v.x + v.x;
    ...
    /**
     * @see https://glmatrix.net/docs/mat4.js.html#line1708
     * @param eye
     * @param target
     * @param up
     */
    public targetTo(eye: ReadonlySimpleVector3, target: ReadonlySimpleVector3, up: ReadonlySimpleVector3): void {
        const eyex = eye.x;
        const eyey = eye.y;
        const eyez = eye.z;
        const upx = up.x;
        ...
        this.data[2] = x2;
        this.data[3] = 0;
        this.data[4] = z1 * x2 - z2 * x1;
        this.data[5] = z2 * x0 - z0 * x2;
        this.data[6] = z0 * x1 - z1 * x0;
        this.data[7] = 0;
        this.data[8] = z0;
        this.data[9] = z1;
        this.data[10] = z2;
    ...
    public rotate(angle: number, axis: ReadonlySimpleVector3): this {
        const { x, y, z } = axis;
    ...
    public static fromRotation(rad: number, axis: SimpleVector3): SimpleMat4;
     ...
     * ```
     */
    public static fromRotation<T extends SimpleMat4>(
        rad: number,
        axis: SimpleVector3,
        result: T = SimpleMat4.create() as unknown as T,
    ): T | null {
    ...
    private static staticSetAngleRotation<T extends SimpleMat4>(
        sin: number,
        cos: number,
        axe: "X" | "Y" | "Z",
        mat: T,
