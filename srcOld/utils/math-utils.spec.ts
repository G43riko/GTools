...
describe("Math utils", () => {
    ...
    describe("Diff", () => {
        it("test diff function", () => {
            expect(MathUtils.getDiff(0, 10)).to.be.equal(10);
            expect(MathUtils.getDiff(10, 0)).to.be.equal(10);
            expect(MathUtils.getDiff(10, 10)).to.be.equal(0);
            expect(MathUtils.getDiff(0, 0)).to.be.equal(0);
        });
    });
    describe("Log2", () => {
