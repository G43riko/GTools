...
describe("sorted-array-utils", () => {
    ...
    it("It should test function sortedPickAll", () => {
        expect(TESTED_OBJ.sortedPickAll(["a", "b", "c"], ["b", "c", "d"], (a, b) => a.localeCompare(b))).to.deep.equal([
            "b",
            "c",
        ]);
    });
    ...
    it("It should test function SortedDifference", () => {
        expect(TESTED_OBJ.SortedDifference(["a", "b", "c"], ["b", "c", "d"], (a, b) => a.localeCompare(b))).to.deep
            .equal([
                "a",
            ]);
    });
    ...
    it("It should test function sortedMerge", () => {
        expect(TESTED_OBJ.sortedMerge(["a", "c", "e"], ["b", "d"], (a, b) => a.localeCompare(b))).to.deep.equal([
            "a",
            "b",
            "c",
            "d",
