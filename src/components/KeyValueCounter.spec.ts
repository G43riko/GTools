...
import "mocha";
import { KeyValueCounter } from "./KeyValueCounter";
...
describe("KeyValueCounter", () => {
    ...
    it("Test object with one value", () => {
        const item               = "testItem";
        const expectedResultItem = {key: item, count: 1};
        counter.add(item);
    ...
    it("Test object with multiple values", () => {
        ...
        const expectedResultItem3 = {key: "testItem3", count: 3};
        const expectedResultItem2 = {key: "testItem2", count: 2};
        const expectedResultItem1 = {key: "testItem1", count: 1};
    ...
    it("Test object with multiple values", () => {
        const items               = ["testItem3", "testItem3", "testItem3", "testItem2", "testItem2", "testItem1"];
        const expectedResultItem3 = {key: "testItem3", count: 6};
        const expectedResultItem2 = {key: "testItem2", count: 4};
        const expectedResultItem1 = {key: "testItem1", count: 2};
        const expectedResultArray = [expectedResultItem1, expectedResultItem2, expectedResultItem3];
        items.forEach((item) => counter.add(item));
