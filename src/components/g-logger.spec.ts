...
import "mocha";
import { GLogger, GLoggerCallbackHolder, GLoggerDefaultFormatter, GLoggerPriority } from "./g-logger";
...
describe("GLogger", () => {
    ...
    describe("It should test correct contexts", () => {
        ...
        // it("It should create glogger from file", () => {
        //     const logger = GLogger.createFileLogger("./log.txt", "Some file context");
        //     expect(logger.context).to.be.equal("Some file context");
        // });
