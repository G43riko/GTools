...
var AABB3 = (function () {
    ...
    AABB3.prototype.expandByScalar = function (distance) {
        this.min.x -= distance;
        this.min.y -= distance;
        this.min.z -= distance;
        this.max.x += distance;
    ...
    AABB3.prototype.expandByVector = function (vec) {
        this.min.x -= vec.x;
        this.min.y -= vec.y;
        this.min.z -= vec.z;
        this.max.x += vec.x;
    ...
    AABB3.prototype.expandBtAABB = function (other) {
    ...
    AABB3.prototype.moveByScalar = function (distance) {
        this.min.x += distance;
        this.min.y += distance;
        this.min.z += distance;
        this.max.x += distance;
    ...
    AABB3.prototype.getCenter = function () {
        return {
    ...
    AABB3.prototype.getSize = function () {
        return {
    ...
    AABB3.prototype.getVolume = function () {
        var size = this.getSize();
        return size.x * size.y * size.z;
    };
    AABB3.prototype.moveByVector = function (vec) {
        this.min.x += vec.x;
        this.min.y += vec.y;
        this.min.z += vec.z;
        this.max.x += vec.x;
    ...
    AABB3.prototype.getMinMax = function () {
        return {
            min: this.min,
            max: this.max,
        };
    };
    AABB3.fromPosAndSize = function (pos, size) {
        return new AABB3({
            x: pos.x,
            y: pos.y,
            z: pos.z,
    ...
    AABB3.prototype.getPosition = function () {
        return {
            x: this.min.x,
            y: this.min.y,
            z: this.min.z,
    ...
    AABB3.fromCenterAndSize = function (center, size) {
        var halfSize = {
            x: size.x / 2,
            y: size.y / 2,
            z: size.z / 2,
    ...
    AABB3.prototype.moveCenterTo = function (center) {
        var offset = {
