...
export class CurveDrawer {
    ...
    public renderPoint(
        ...
        color: string = this.pointColor,
        size: number = this.pointSize,
    ): void {
    ...
    /*
    public drawCurvePoints(context: CanvasRenderingContext2D, curve: Curve2D, color: string = this.pointColor, size: number = this.pointSize): void {
