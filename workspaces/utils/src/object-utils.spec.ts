...
import { getNestedProperty, getOrSetProperty, isPlain, makeFlat, setNestedProperty } from "./object-utils.ts";
...
describe("ObjectUtils", () => {
    ...
    describe("makeFlat", () => {
        ...
        it("should flatten the list based on the property path", () => {
            expect(makeFlat(items, "person.name")).toEqual(["Gabriel", "Ella", "Gabriel", "Joe", undefined]);
            expect(makeFlat(items, "person.name", ".", true)).toEqual(["Gabriel", "Ella", "Gabriel", "Joe"]); // Skip undefined
            expect(makeFlat(items, "person_name", "_")).toEqual(["Gabriel", "Ella", "Gabriel", "Joe", undefined]);
            expect(makeFlat(items, "person_name", "_", true)).toEqual(["Gabriel", "Ella", "Gabriel", "Joe"]); // Skip undefined
        });
